...
function App() {
    ...
    const fetchItems = async () => {
        try {
            const response = await axios.get('http://192.168.137.68:3000/api/items');
    ...
    const addItem = async () => {
        try {
            await axios.post('http://192.168.137.68:3000/api/items', newItem);
            fetchItems();
    ...
    const deleteItem = async (id) => {
        try {
            await axios.delete(`http://192.168.137.68:3000/api/items/${id}`);
            fetchItems();
        } catch (error) {
    ...
    const searchItems = async () => {
        try {
            const response = await axios.get(`http://192.168.137.68:3000/api/items/search?query=${searchQuery}`);
            setItems(response.data);
        } catch (error) {
